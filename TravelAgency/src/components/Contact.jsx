        ...
        <Grid>
          <Row className="show-grid text-center">
            <Col xs={12} sm={4}>
              ...
              <p>
                At Friends Travels we want to make sure that your trip is
                ...
                cabs, plan your adventure or get help with any problems you
                encounter along the way. Or if you’re in Jeypore, you can visit
            ...
            <Col xs={12} sm={4} className="person-wrapper">
              ...
              <ul className=" contact-list fa-ul">
                <li>
                  <i class="fas fa-map-marker-alt"></i> Prasad Rao Peta 4th
                  Lane, Jeypore, Koraput, Odisha.{" "}
                </li>
                <li>
                  <i class="fas fa-phone"></i> 7894242666
                </li>
                <li>
                  <i class="fas fa-mobile-alt"></i> 8763976769
                </li>
                <li>
